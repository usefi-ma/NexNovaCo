...
public sealed record SiteContactContent(string Phone, string Email, string Address);
...
public sealed record ContactContent(InnerPageHeroContent Hero, ContactInfoContent Info,
    ContactFormContent Form, ContactMapContent Map, string HeroImagePath = MediaPolicy.ContactHeroDefault);
