...
public enum MediaKind { Hero, Welcome, Member, Partner, AboutHero, AboutVision, ServicesHero, ServicesBenefits, ProjectsHero }
...
public static partial class MediaPolicy
{
    ...
    public static int MaxBytes(MediaKind kind) => kind is MediaKind.Hero or MediaKind.Welcome or MediaKind.AboutHero or MediaKind.AboutVision or MediaKind.ServicesHero or MediaKind.ServicesBenefits or MediaKind.ProjectsHero ? 5 * 1024 * 1024 : 3 * 1024 * 1024;
    ...
    [GeneratedRegex(@"\Auploads/(?:home|team|partners|about|services|projects)/[a-f0-9]{32}\.(?:jpg|png|webp)\z", RegexOptions.CultureInvariant)]
